...
It makes your local AI coding chats searchable. It reads Codex and Claude Code
history, builds a local SQLite index, and lets you search it from the terminal
or through MCP.
